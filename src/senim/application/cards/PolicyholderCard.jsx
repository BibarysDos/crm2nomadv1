...
const PolicyholderCard = ({ policyholderData, onOpen }) => {
  return (
    <div
      data-layer="Сounterparty Policyholder"
      data-state={policyholderData ? 'pressed' : 'not_pressed'}
      className="OunterpartyPolicyholder"
      style={{
        alignSelf: 'stretch',
        background: 'white',
        overflow: 'hidden',
    ...
    >
      <div
        data-layer="Sections Policyholder"
        className="SectionsPolicyholder"
        style={{
          alignSelf: 'stretch',
          height: 85,
          paddingLeft: 20,
      ...
      {policyholderData ? (
        <>
          ...
          >
            ...
            >
              ...
              >
                {[
                  policyholderData.surname || policyholderData.lastName,
                  policyholderData.name || policyholderData.firstName,
                  policyholderData.patronymic || policyholderData.middleName
                ]
                  .filter(Boolean)
                  .join(' ') || ''}
              </div>
        ...
        >
              ...
              >
                <g clipPath="url(#clip0_373_647)">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M0.916504 11C0.916504 5.43095 5.43083 0.916626 10.9998 0.916626C16.5688 0.916626 21.0832 5.43095 21.0832 11C21.0832 16.569 16.5688 21.0833 10.9998 21.0833C5.43083 21.0833 0.916504 16.569 0.916504 11ZM10.9998 2.74996C6.44335 2.74996 2.74984 6.44347 2.74984 11C2.74984 15.5564 6.44335 19.25 10.9998 19.25C15.5563 19.25 19.2498 15.5564 19.2498 11C19.2498 6.44347 15.5563 2.74996 10.9998 2.74996ZM10.074 7.33329C10.074 6.82703 10.4844 6.41663 10.9907 6.41663H10.9998C11.5061 6.41663 11.9165 6.82703 11.9165 7.33329C11.9165 7.83955 11.5061 8.24996 10.9998 8.24996H10.9907C10.4844 8.24996 10.074 7.83955 10.074 7.33329ZM10.9998 10.0833C11.5061 10.0833 11.9165 10.4937 11.9165 11V14.6666C11.9165 15.1729 11.5061 15.5833 10.9998 15.5833C10.4936 15.5833 10.0832 15.1729 10.0832 14.6666V11C10.0832 10.4937 10.4936 10.0833 10.9998 10.0833Z"
                    fill="black"
                  />
                </g>
                <defs>
          ...
          >
            Нажмите на поле страхователь, чтобы заполнить данные
          </div>
        </div>
      )}
    </div>
