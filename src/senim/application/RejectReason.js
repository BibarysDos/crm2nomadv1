...
const RejectReason = ({ 
  ...
  return (
    <div data-layer="Reject reason page" className="RejectReasonPage" style={{width: 1512, minHeight: '100vh', background: 'white', overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'stretch', display: 'inline-flex'}}>
