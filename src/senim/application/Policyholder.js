...
export const mapInsuredToContragent = (data, insuredType, loadedIdentifier = null) => {
  ...
  const normalizeDateForInsured = (dateValue) => {
  ...
  const identityDocData = {
    ...
    ...(normalizeDateForInsured(data.issueDate) ? { issuedDate: normalizeDateForInsured(data.issueDate) } : {}),
    ...(normalizeDateForInsured(data.expiryDate) ? { expireDate: normalizeDateForInsured(data.expiryDate) } : {}),
  };
  ...
  const detailData = {
    ...
    ...(normalizeDateForInsured(data.birthDate) ? { birthDate: normalizeDateForInsured(data.birthDate) } : {}),
